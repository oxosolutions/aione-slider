		...
		if ( get_post_status ( $slider_id ) == 'publish' ) {
			if ( get_post_type( $slider_id ) == 'aione-slider' ) {
				...
				*/
				...
				$settings['auto-hight'] = $autohight;
				$settings['u-r-lhash-listener'] = $urlhashlistener;
				$settings['nav'] = $nav;
				$settings['slideby'] = $slideby;
				$settings['slide-transition'] = $slidetransition;
				$settings['dots'] = $dots;
				$settings['lazy-load'] = $lazyload;
				$settings['autoplay'] = $autoplay;
				$settings['autoplay-timeout'] = $autoplaytimeout;
				$settings['autoplay-hover-pause'] = $autoplayhoverpause;
				...
				$settings['nav-text'] = "[]";
				$settings['responsive-class'] = $responsive_class;
